...
feel free to join the [HackInjectLab Telegram](https://t.me/hackinjectlab).
...
First of all,
thanks a lot to all contributors of ArisuFxPy and all of its users.

ArisuFxPy is a maintained fork of [UnityPy](https://github.com/K0lb3/UnityPy) by [K0lb3](https://github.com/K0lb3), released under the MIT License. Full credit for the original engine and design goes to K0lb3 and the UnityPy contributors.
