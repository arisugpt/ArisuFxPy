...
# import ArisuFxPy from the parent directory instead of the installed package
ROOT = os.path.dirname(os.path.dirname(os.path.abspath(__file__)))
sys.path.append(ROOT)
from ArisuFxPy.helpers.Tpk import TpkUnityNode, get_typetree  # noqa: E402
from ArisuFxPy.helpers.TypeTreeNode import clean_name  # noqa: E402
